...
export const modulePrototypes: Record<string, ModulePrototype> = {
    ...
    interfaces: [
      {
        ...
        requestFields: [
          { name: 'expertA', type: 'string', required: '是', description: '专家 A 姓名' },
          { name: 'expertB', type: 'string', required: '是', description: '专家 B 姓名' },
          { name: 'start_time', type: 'string', required: '否', description: '查询开始时间，格式 YYYY-MM' },
          { name: 'end_time', type: 'string', required: '否', description: '查询结束时间，格式 YYYY-MM' },
        ],
        responseFields: [
        ...
        graph: {
          nodes: [
            ...
            { id: 'period', x: 110, y: 498, w: 220, h: 78, title: '关联维度', subtitle: '博士研究生｜2015级｜2019届', tone: 'purple' },
            { id: 'coop', x: 568, y: 468, w: 170, h: 108, title: '后续合作', tone: 'orange', chips: ['论文3', '专利1', '项目2'] },
          ],
          edges: [
            ...
            { id: 'e7', path: 'M346 486 C326 516 296 532 246 537', label: '关联维度', labelX: 346, labelY: 522, tone: 'green' },
            { id: 'e8', path: 'M506 486 C536 526 550 538 568 532', label: '毕业后合作', labelX: 506, labelY: 522, tone: 'orange' },
          ],
        },
      },
    ],
  ...
  'industry-chain-event': {
    ...
    requirement:
      '针对产业链特定环节，通过事件影响力评估算法筛选核心事件，构建事件与专家关联，并按事件与产业链维度分析影响。',
    flow: ['输入产业链节点', '筛选高影响事件', '构建事件专家关系', '分析事件影响'],
    interfaces: [
      {
        name: '高影响力事件筛选接口',
        endpoint: '/api/v1/industry-chain/topn-events/screen',
        method: 'POST',
        purpose: '根据产业链节点/环节代码、事件类型和时间范围，筛选影响力排名前 N 的核心事件。',
        requestFields: [
          { name: 'industryChainName', type: 'string', required: '是', description: '产业链中文名称，如集成电路产业链' },
          { name: 'industryChainSegment', type: 'string', required: '是', description: '产业链环节或节点，如上游原材料' },
          { name: 'eventTypes', type: 'string', required: '否', description: '事件类型单选，如专利突破、论文成果、融资并购' },
        ...
        responseFields: [
          ...
          { name: 'success', type: 'bool', description: '是否成功' },
          { name: 'msg', type: 'string', description: '提示消息' },
          { name: 'data.industryChainName', type: 'string', description: '当前分析的产业链中文名称' },
          { name: 'data.industryChainSegment', type: 'string', description: '当前分析的产业链环节/节点' },
          { name: 'data.industryChainNodeCode', type: 'string', description: '当前分析的产业链内部追踪代码' },
          { name: 'data.total', type: 'int', description: '命中事件总数' },
          { name: 'data.topN', type: 'number', description: '本次返回的事件数量限制' },
          { name: 'data.events', type: 'array', description: 'TOP-N 事件列表' },
          { name: 'data.events[].impactScore', type: 'number', description: '影响力得分' },
          { name: 'data.events[].eventTime', type: 'string', description: '中文格式事件时间' },
          { name: 'data.events[].relatedExpertName', type: 'string', description: '关联专家/人才姓名' },
        ],
        ...
        responseExample: {
          ...
          data: {
            ...
            topN: 10,
            events: [
              { eventId: 'EVT_PATENT_001', eventTitle: '高性能半导体材料制备关键技术专利', eventTime: '2024年6月15日', impactScore: 92.5, rank: 1, relatedExpertName: '陈建国' },
              { eventId: 'EVT_PAPER_001', eventTitle: '面向先进制造的关键材料性能优化研究', eventTime: '2023年11月20日', impactScore: 86.0, rank: 2, relatedExpertName: '刘芳' },
            ],
          },
          msg: 'success',
        },
        detailRows: [
          ['产业链节点', '集成电路产业链'],
          ['事件类型', '全部事件类型'],
          ['时间范围', '2020年1月1日 至 2024年12月31日'],
          ['返回数量', '10'],
          ['第1事件', '高性能半导体材料制备关键技术专利'],
          ['第1关联专家', '陈建国'],
          ['第2事件', '战略融资投向低碳原材料产线'],
          ['第2关联专家', '李佳宁'],
          ['第3事件', '材料缺陷预测模型论文发表'],
        ...
        graph: {
          nodes: [
            ...
            { id: 'events', x: 548, y: 226, w: 164, h: 72, title: '高影响事件', subtitle: '核心事件集', tone: 'orange' },
            { id: 'top1', x: 42, y: 442, w: 132, h: 60, title: '第一事件', subtitle: '算力芯片突破', tone: 'purple' },
            { id: 'top2', x: 210, y: 456, w: 132, h: 60, title: '第二事件', subtitle: '多模态发布', tone: 'purple' },
            { id: 'top3', x: 378, y: 442, w: 132, h: 60, title: '第三事件', subtitle: '开源生态升级', tone: 'purple' },
          ...
          edges: [
            ...
            { id: 'e7', path: 'M548 280 C402 348 190 382 108 442', label: '第一', labelX: 316, labelY: 370, tone: 'orange', dashed: true },
            { id: 'e8', path: 'M588 298 C520 380 350 420 276 456', label: '第二', labelX: 448, labelY: 406, tone: 'orange', dashed: true },
            { id: 'e9', path: 'M626 298 C594 374 506 410 444 442', label: '第三', labelX: 550, labelY: 406, tone: 'orange', dashed: true },
      ...
      {
        name: '事件-专家关系查询接口',
        endpoint: '/api/v1/industry-chain/topn-events/event-expert-relations/query',
        method: 'POST',
        purpose: '根据指定事件和专家，查询事件与专家之间的关系说明。',
        requestFields: [
          { name: 'eventName', type: 'string', required: '是', description: '事件中文名称，从高影响力事件筛选接口结果中选择' },
          { name: 'expertName', type: 'string', required: '是', description: '专家/人才中文姓名，从所选事件的关联专家中选择' },
        ],
        responseFields: [
          { name: 'code', type: 'int', description: '业务状态码，200 成功' },
          { name: 'success', type: 'bool', description: '是否成功' },
          ...
          { name: 'data.relations[].eventTitle', type: 'string', description: '事件标题' },
          { name: 'data.relations[].expertId', type: 'string', description: '专家 ID' },
          { name: 'data.relations[].expertName', type: 'string', description: '专家/人才姓名' },
          ...
          { name: 'data.relations[].organization', type: 'string', description: '专家所属机构' },
          { name: 'data.relations[].effective', type: 'bool', description: '关系是否有效' },
        ],
        requestExample: { eventName: '高纯前驱体材料制备专利授权', expertName: '陈建国' },
        responseExample: { code: 200, success: true, data: { relations: [{ relationId: 'REL_EVT001_EXP001', eventId: 'EVT_PATENT_001', eventTitle: '高性能半导体材料制备关键技术专利', expertId: 'EXP001', expertName: '陈建国', relationType: 'inventor', roleLabel: '发明人', organization: '某某大学材料学院', effective: true }, { relationId: 'REL_EVT002_EXP002', eventId: 'EVT_PAPER_001', eventTitle: '面向先进制造的关键材料性能优化研究', expertId: 'EXP002', expertName: '刘芳', relationType: 'author', roleLabel: '作者', organization: '某某研究院', effective: true }] }, msg: 'success' },
        detailRows: [
          ['事件1', '高性能半导体材料制备关键技术专利'],
          ['人才1', '陈建国'],
          ['关系描述1', '陈建国作为发明人参与该专利事件，承担关键材料制备方案设计与实验验证。'],
          ['事件2', '面向先进制造的关键材料性能优化研究'],
          ['人才2', '刘芳'],
          ['关系描述2', '刘芳作为作者参与该论文事件，负责关键材料性能建模与实验数据分析。'],
        ],
        graph: {
          nodes: [
            { id: 'events', x: 48, y: 62, w: 270, h: 126, title: '产业链科技事件', subtitle: '输入事件集合', tone: 'orange', chips: ['高性能材料专利', '材料性能论文'] },
            { id: 'experts', x: 582, y: 62, w: 270, h: 126, title: '核心科研专家', subtitle: '输入专家集合', tone: 'green', chips: ['陈建国', '刘芳'] },
            { id: 'relation', x: 340, y: 228, w: 220, h: 126, title: '事件-专家关系', subtitle: '构建关系边', tone: 'purple', chips: ['发明人关系', '作者关系'] },
            { id: 'roles', x: 48, y: 392, w: 270, h: 118, title: '关联角色类型', subtitle: '关系语义标注', tone: 'blue', chips: ['发明人', '作者', '项目参与人'] },
            { id: 'result', x: 582, y: 392, w: 270, h: 118, title: '关系构建结果', subtitle: '写入/合并关系边', tone: 'gold', chips: ['关系说明', '有效关系'] },
          ],
          edges: [
            { id: 'event-relation', path: 'M318 125 C364 158 376 210 394 228', label: '事件输入', labelX: 372, labelY: 176, tone: 'orange' },
            { id: 'expert-relation', path: 'M582 125 C536 158 524 210 506 228', label: '专家输入', labelX: 528, labelY: 176, tone: 'green' },
            { id: 'role-relation', path: 'M318 450 C366 416 382 370 410 354', label: '角色标注', labelX: 368, labelY: 402, tone: 'blue' },
            { id: 'relation-result', path: 'M560 290 C624 320 676 356 714 392', label: '生成关系边', labelX: 642, labelY: 346, tone: 'gold' },
          ],
        },
      },
      {
        ...
        method: 'POST',
        purpose: '针对单条产业链重点事件，从产业链范围维度分析事件影响力。',
        requestFields: [
          { name: 'eventName', type: 'string', required: '是', description: '事件中文名称，从高影响力事件筛选接口结果中选择' },
          { name: 'industryChainName', type: 'string', required: '是', description: '产业链中文名称，由所选事件所属产业链限定' },
          { name: 'industryChainSegment', type: 'string', required: '是', description: '产业链环节或节点，由所选事件所属环节限定' },
        ],
        responseFields: [
          { name: 'code', type: 'int', description: '业务状态码，200 成功' },
          { name: 'success', type: 'bool', description: '是否成功' },
          { name: 'msg', type: 'string', description: '提示消息' },
          { name: 'data.keyEventName', type: 'string', description: '重点事件名称' },
          { name: 'data.industryChainName', type: 'string', description: '产业链名称' },
          { name: 'data.industryChainSegment', type: 'string', description: '产业链环节或节点' },
          { name: 'data.impactCoverage', type: 'object', description: '影响覆盖面' },
          { name: 'data.impactCoverage.affectedNodes', type: 'array', description: '受影响的产业链节点' },
          { name: 'data.impactCoverage.affectedEnterprises', type: 'array', description: '受影响企业' },
          { name: 'data.impactCoverage.affectedExperts', type: 'array', description: '受影响或关联专家' },
          { name: 'data.riskWarning', type: 'string', description: '风险预警' },
          { name: 'data.opportunity', type: 'string', description: '机会挖掘提示' },
        ],
        requestExample: { eventName: '高纯前驱体材料制备专利授权', industryChainName: '集成电路产业链', industryChainSegment: '上游原材料' },
        responseExample: { code: 200, success: true, data: { keyEventName: '高性能半导体材料制备关键技术专利', industryChainName: '集成电路产业链', industryChainSegment: '上游原材料', impactCoverage: { affectedNodes: ['上游原材料', '中游制造'], affectedEnterprises: ['企业001有限公司'], affectedExperts: ['陈建国'], impactDescription: '该事件主要影响上游原材料制备环节，并可能向中游制造环节传导。' }, riskWarning: '需关注上游原材料供应集中度和技术替代风险。', opportunity: '可围绕关键材料制备技术布局产业化合作和成果转化。' }, msg: 'success' },
        detailRows: [
          ['重点事件名称', '高性能半导体材料制备关键技术专利'],
          ['产业链环节/节点', '上游原材料'],
          ['事件影响', '推动上游原材料工艺升级，降低中游制造环节成本，并对相关装备制造环节产生带动作用。'],
          ['风险预警', '上游原材料供应集中度较高，存在供应稳定性风险。'],
          ['机遇挖掘', '下游制造环节具备产业化合作机会。'],
        ],
        graph: {
          nodes: [
            { id: 'event', x: 42, y: 214, w: 260, h: 126, title: '产业链重点事件', subtitle: '专利事件', tone: 'orange', chips: ['高纯材料', '二零二四年六月'] },
            { id: 'coverage', x: 340, y: 204, w: 240, h: 146, title: '影响覆盖面', subtitle: '覆盖评分 78.0', tone: 'purple', chips: ['节点', '企业', '专家'] },
            { id: 'nodes', x: 620, y: 50, w: 250, h: 120, title: '影响节点', subtitle: '产业链范围', tone: 'blue', chips: ['上游原材料', '中游制造'] },
            { id: 'conduction', x: 700, y: 252, w: 188, h: 120, title: '行业传导效应', subtitle: '上下游/跨链', tone: 'green', chips: ['工艺升级', '成本降低', '跨链辐射'] },
            { id: 'trend', x: 340, y: 416, w: 240, h: 120, title: '影响分析', subtitle: '产业链范围', tone: 'gold', chips: ['短期上升', '中期平稳', '长期上升'] },
            { id: 'risk', x: 42, y: 416, w: 260, h: 120, title: '风险与机会', subtitle: '预警/机会挖掘', tone: 'orange', chips: ['供应集中', '制造合作'] },
          ],
          edges: [
            { id: 'event-coverage', path: 'M185 214 C250 166 366 166 430 204', label: '影响分析', labelX: 308, labelY: 162, tone: 'orange' },
            { id: 'coverage-nodes', path: 'M580 242 C604 196 628 146 620 110', label: '影响节点', labelX: 596, labelY: 190, tone: 'blue' },
            { id: 'coverage-conduction', path: 'M580 300 C624 326 664 326 700 312', label: '传导效应', labelX: 620, labelY: 286, tone: 'green' },
            { id: 'coverage-trend', path: 'M460 350 C460 376 460 394 460 416', label: '趋势研判', labelX: 512, labelY: 384, tone: 'gold' },
            { id: 'trend-risk', path: 'M460 536 C390 558 252 558 172 536', label: '风险机会', labelX: 316, labelY: 552, tone: 'orange', dashed: true },
          ],
        },
      },
    ],
  ...
  'industry-chain-panorama': {
    title: '科技产业链全景图',
    requirement:
      '清晰展示产业链各环节的核心节点、关联关系与数据流向，标注各环节关键技术、重点企业与核心专家，同时支持根据用户需求进行层级展开、关系筛选与动态更新。',
    ...
    interfaces: [
      {
        ...
        method: 'POST',
        purpose: '以产业链代码作为查询入口，支持按照产业链节点层级和关系类型进行筛选，返回指定产业链的全景图数据。',
        requestFields: [
          { name: 'chain_code', type: 'string', required: '是', description: '产业链代码，用于唯一定位要查询的产业链' },
          { name: 'level', type: 'number', required: '否', description: '产业链节点展开层级，默认值按接口约定' },
          { name: 'relation_type', type: 'string', required: '否', description: '关系类型筛选条件，默认返回全部关系' },
          { name: 'limit', type: 'number', required: '否', description: '返回结果数量限制，默认值按接口约定' },
        ],
        responseFields: [
          { name: 'code', type: 'int', description: '业务状态码' },
          { name: 'message', type: 'string', description: '返回消息' },
          { name: 'data.chain_info', type: 'object', description: '产业链基本信息，包括代码、名称、描述、更新时间等' },
          { name: 'data.nodes', type: 'array', description: '产业链图谱节点列表，包括产业环节、核心节点、关键技术、重点企业、核心专家、产业事件等' },
          { name: 'data.relations', type: 'array', description: '图谱关系列表，包括上下游关系、数据流向关系、技术支撑关系、企业布局关系、专家支撑关系、事件关联关系等' },
          { name: 'data.data_flows', type: 'array', description: '产业链各环节之间的数据流向信息' },
          { name: 'data.technologies', type: 'array', description: '各产业链节点关联的关键技术信息' },
          { name: 'data.enterprises', type: 'array', description: '各产业链节点关联的重点企业信息' },
          { name: 'data.experts', type: 'array', description: '各产业链节点或关键技术关联的核心专家信息' },
          { name: 'data.events', type: 'array', description: '产业链相关动态事件信息' },
          { name: 'data.update_info', type: 'object', description: '数据版本、更新时间、更新状态等动态更新信息' },
          { name: 'data.statistics', type: 'object', description: '返回结果统计信息，包括节点数、关系数、企业数、专家数、事件数等' },
        ],
        requestExample: { chain_code: 'AI_CHAIN', level: 3, relation_type: 'all', limit: 100 },
        responseExample: { code: 0, message: 'success', data: { chain_info: { chain_code: 'AI_CHAIN', chain_name: '人工智能产业链', description: '围绕人工智能核心技术、基础设施、平台服务和应用场景形成的产业链结构', update_time: '2026-07-02 10:30:00' }, nodes: [{ node_id: 'AI_CHAIN', node_name: '人工智能产业链', node_type: '产业链', level: 0 }, { node_id: 'ai-up', node_name: '上游基础资源', node_type: '产业节点', level: 1 }], relations: [{ relation_id: 'R001', source_node_id: 'ai-up', target_node_id: 'ai-core', relation_type: 'upstream_downstream', relation_name: '上下游关系' }], data_flows: [{ source_node_id: 'ai-up', target_node_id: 'ai-core', flow_name: '上下游关系', flow_description: '上游基础资源向中游核心技术提供数据集、算力指标、模型训练日志' }], technologies: [], enterprises: [], experts: [], events: [], update_info: { data_version: 'v20260702', last_update_time: '2026-07-02 10:30:00', is_updated: true, update_description: '产业链节点、企业布局和产业动态数据已更新' }, statistics: { node_count: 3, relation_count: 2, technology_count: 8, enterprise_count: 12, expert_count: 6, event_count: 5 } } },
        detailRows: [
          ['产业链名称', '人工智能产业链'],
          ['产业链代码', 'AI_CHAIN'],
          ['展开层级', '3'],
          ['关系筛选', 'all'],
          ['数据更新时间', '2026-07-02 10:30:00'],
          ['节点1名称', '上游基础资源｜产业节点｜L1'],
          ['节点1关键技术', '数据治理、算力芯片、向量数据库'],
          ['节点1重点企业', '寒武纪、阿里云、华为昇腾'],
          ['节点1核心专家', '李佳宁、张明远'],
          ['节点2名称', '中游核心技术｜产业节点｜L2'],
          ['节点2关键技术', '知识图谱、机器学习、大模型'],
          ['节点2重点企业', '百度智能云、智谱AI、同欣怡'],
          ['节点2核心专家', '周欣怡、王启航'],
          ['节点3名称', '下游应用场景｜产业节点｜L3'],
          ['节点3关键技术', '智能制造、智慧医疗、自动驾驶'],
          ['节点3重点企业', '科大讯飞、时视科技、深澜新能源'],
          ['节点3核心专家', '陈思远、赵清宁'],
          ['关联关系', '上游基础资源 → 中游核心技术｜上下游关系｜数据集 / 算力指标 / 模型训练日志'],
          ['数据流向', '中游核心技术 → 下游应用场景｜API服务 / 推理结果 / 行业知识库'],
          ['产业动态事件', '智算中心扩容、国产算力适配、多模态模型升级、产业合作发布、行业大模型落地、场景应用示范'],
          ['统计信息', '节点 3｜关系 3｜企业 9｜专家 6｜技术 9｜专利 58｜事件 6'],
        ],
        graph: {
          nodes: [
