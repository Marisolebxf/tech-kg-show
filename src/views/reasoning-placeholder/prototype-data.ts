      ...
      },
      {
        ...
        graph: {
          nodes: [
            ...
            { id: 'period', x: 76, y: 498, w: 220, h: 78, title: '共同学习时段', subtitle: '2015.09 - 2019.06', tone: 'purple' },
          ...
          edges: [
            ...
            { id: 'e7', path: 'M346 486 C306 526 284 536 210 537', label: '学习时段', labelX: 346, labelY: 522, tone: 'green' },
  ...
  'industry-chain-event': {
    ...
    interfaces: [
      ...
      },
      {
        ...
        requestExample: { eventIds: ['P001', 'PAPER001'], expertIds: ['COOP-SCH001', 'COOP-SCH002'], relationTypes: ['inventor', 'author', 'participant'] },
        ...
        detailRows: [
          ['产业链事件', ['P001｜专利事件', 'PAPER001｜论文事件']],
          ['关联科技专家/人才', ['陈建国｜发明人｜关联事件：P001', '刘芳｜作者｜关联事件：PAPER001']],
          ['事件-专家关系', ['P001 —— 发明人 —— 陈建国', 'PAPER001 —— 作者 —— 刘芳']],
        ],
        graph: {
          nodes: [
            { id: 'events', x: 48, y: 62, w: 270, h: 126, title: '产业链科技事件', subtitle: '输入事件集合', tone: 'orange', chips: ['P001', 'PAPER001'] },
            { id: 'experts', x: 582, y: 62, w: 270, h: 126, title: '核心科研专家', subtitle: '输入专家集合', tone: 'green', chips: ['陈建国', '刘芳'] },
            { id: 'relation', x: 340, y: 228, w: 220, h: 126, title: '事件-专家关系', subtitle: '构建关系边', tone: 'purple', chips: ['EV001-S001', '有效'] },
            { id: 'roles', x: 48, y: 392, w: 270, h: 118, title: '关联角色类型', subtitle: '关系语义标注', tone: 'blue', chips: ['发明人', '作者', '项目参与人'] },
            { id: 'result', x: 582, y: 392, w: 270, h: 118, title: '关系构建结果', subtitle: '写入/合并关系边', tone: 'gold', chips: ['关系ID', '有效', '无跳过'] },
          ],
          edges: [
      ...
      },
      {
        ...
        requestExample: { eventId: 'P001', analysisScope: 'industry_chain', timeHorizonYears: 3 },
        ...
        detailRows: [
          ['重点事件', 'CN2024XXXXXXA｜专利事件'],
          ['影响产业链节点', '上游原材料、中游制造'],
          ['事件影响', '推动上游原材料工艺升级，降低中游制造环节成本，并对相关装备制造环节产生带动作用。'],
          ['后续发展趋势', ['短期：同类技术跟进增加', '中期：进入产业化验证阶段', '长期：形成技术标准，带动产业链升级']],
          ['风险预警', '上游原材料供应集中度较高，存在供应稳定性风险。'],
          ['机遇挖掘', '下游制造环节具备产业化合作机会。'],
        ],
        graph: {
          nodes: [
            { id: 'event', x: 42, y: 214, w: 260, h: 126, title: '产业链重点事件', subtitle: 'P001｜专利事件', tone: 'orange', chips: ['高纯材料', '2024-06'] },
            ...
            { id: 'trend', x: 340, y: 416, w: 240, h: 120, title: '发展演化趋势', subtitle: '3个月周期', tone: 'gold', chips: ['短期上升', '中期平稳', '长期上升'] },
    ...
    interfaces: [
      {
        ...
        responseFields: [
          ...
          { name: 'data.data_flow', type: 'array', description: '数据流向' },
          { name: 'data.key_technologies', type: 'array', description: '关键技术' },
          { name: 'data.experts', type: 'array', description: '核心专家' },
          { name: 'data.statistics', type: 'object', description: '统计汇总' },
        ],
        requestExample: { chain_code: 'AI', chain_name: '人工智能', node_id: '', node_name: '', level: '', relation_type: '', include_enterprise: true, include_expert: true, include_patent: true, include_product: true, include_news: true, limit: 50 },
        responseExample: { code: 0, message: 'success', data: { chain: { chain_code: 'AI', chain_name: '人工智能', chain_path: '人工智能 / 上游基础资源 / 中游核心技术 / 下游应用场景', node_total: 3, enterprise_total: 4, expert_total: 3, patent_total: 18, product_total: 3, news_total: 3 }, nodes: [{ node_name: '上游基础资源', level: 1 }, { node_name: '中游核心技术', level: 2 }, { node_name: '下游应用场景', level: 3 }], relations: [{ relation_type: '上下游', relation_strength: 95 }], data_flow: ['算力、数据资源、算法框架由上游基础资源流向中游核心技术', '模型能力、算法服务由中游核心技术流向下游应用场景'], key_technologies: ['模型训练', '推理优化', '知识图谱', '机器学习', '大模型'], enterprises: ['百度', '阿里云', '华为', '智谱'], experts: ['陈建国', '刘芳', '周欣怡'], statistics: { node_count: 3, relation_count: 2, enterprise_count: 4, expert_count: 3, patent_count: 18, product_count: 3, news_count: 3 } } },
        detailRows: [
          ['产业链', '人工智能'],
          ['核心节点', ['上游基础资源｜L1', '中游核心技术｜L2', '下游应用场景｜L3']],
          ['节点层级', '人工智能 / 上游基础资源 / 中游核心技术 / 下游应用场景'],
          ['上下游关系', '上游基础资源 → 中游核心技术 → 下游应用场景'],
          ['数据流向', ['算力、数据资源、算法框架由上游基础资源流向中游核心技术', '模型能力、算法服务由中游核心技术流向下游应用场景']],
          ['关键技术', '模型训练、推理优化、知识图谱、机器学习、大模型'],
          ['重点企业', '百度、阿里云、华为、智谱等'],
          ['核心专家', '陈建国、刘芳、周欣怡等'],
          ['专利产品', '专利 18 件，代表产品包括大模型平台、AI服务器、智能诊断系统。'],
          ['动态资讯/事件', '产业合作发布、研发投入变化、技术升级动态。'],
          ['运行态势', '上游资源持续增强，中游技术持续迭代，下游应用场景扩展。'],
          ['发展机遇', '智能制造、智慧医疗、自动驾驶等应用场景具备产业化发展机会。'],
          ['统计信息', ['节点数量：3', '关系数量：若干', '企业数量：若干', '专家数量：若干', '专利数量：若干', '产品数量：若干', '动态资讯数量：若干']],
        ],
        graph: {
          nodes: [
